...
describe("SushiBar", function () {
  ...
  it("should calculate the percentage of unstaked amount after certain days", async function() {
    await this.bar.stakedAmount("50")
    await expect(this.bar.unstakeDetails("10")).to.be.revertedWith("ERC20: All locked up")
  })
})
